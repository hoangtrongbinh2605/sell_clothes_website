...
<!-- Container fluid  -->
    ...
    <script>
        CKEDITOR.replace( 'content', {
            filebrowserBrowseUrl: 'http://laravelapilocal.com/ckfinder/ckfinder.html',
            filebrowserImageBrowseUrl: 'http://laravelapilocal.com/ckfinder/ckfinder.html?type=Images',
            filebrowserFlashBrowseUrl: 'http://laravelapilocal.com/ckfinder/ckfinder.html?type=Flash',
            filebrowserUploadUrl: 'http://laravelapilocal.com/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
            filebrowserImageUploadUrl: 'http://laravelapilocal.com/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
            filebrowserFlashUploadUrl: 'http://laravelapilocal.com/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
        } );
     </script>
