			...
			<div class="well text-center">
				...
				@csrf 
					<input type="text" class="span2" value="" data-slider-min="0" data-slider-max="10000000" data-slider-step="5" data-slider-value="[0,10000000]" id="sl2" ><br />
				 	...
				 	<!-- <input type="text" id="min" name="min" value="" hidden>
				 	<input type="text" id="max" name="max" value="" hidden> -->
				 	<!-- <button type="submit" class="btn btn-default search-price">Find</button> -->
				<!-- </form> -->
