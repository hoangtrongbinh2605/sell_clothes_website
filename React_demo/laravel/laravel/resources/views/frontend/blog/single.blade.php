...
<div class="col-sm-9">
					...
					<div class="response-area">
						...
						<ul class="media-list">
							...
							<?php if($value->id_comment == 0){ ?>
								<li class="media">
									...
									<a class="pull-left" href="#">
										...
										<img class="media-object" style="width: auto !important; " src=" {{ URL::to('/upload/user/avatar/'.$value->image_user) }}" alt="">
									</a>
								...
								<?php if($value1->id_comment == $value->id){ ?>
									...
									<a class="pull-left" href="#">
										<img class="media-object" style="width: auto !important; " src="{{ URL::to('/upload/user/avatar/'.$value1->image_user) }}" alt="">
									</a>
									<div class="media-body">
										<ul class="sinlge-post-meta">
							...
							<!-- <li class="media second-media">
								<a class="pull-left" href="#">
									<img class="media-object" src="{{URL::to('/upload/images/blog/man-three.jpg')}}" alt="">
								</a>
								<div class="media-body">
									<ul class="sinlge-post-meta">
							...
							<!-- <li class="media">
								<a class="pull-left" href="#">
									<img class="media-object" src="{{URL::to('/upload/images/blog/man-four.jpg')}}" alt="">
								</a>
								<div class="media-body">
									<ul class="sinlge-post-meta">
										<li><i class="fa fa-user"></i>Janis Gallagher</li>
